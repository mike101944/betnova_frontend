      ...
      <div class="scrollable-ios flex-1 px-4 pb-20 pt-4">
        ...
        <div v-if="activeTab === 'sports'" class="space-y-6">
          ...
          <div v-else class="space-y-4">
              ...
              <div v-if="currentSelectionsCount > 0" class="flex flex-row-reverse justify-between items-center px-0  bg-transparent ">
                <button 
                  @click="clearAllSelections"
                  class="px-3 py-1.5 bg-gray-300 cursor-pointer text-red-700 text-xs font-medium rounded-lg transition-colors duration-200 flex items-center gap-1"
                >
                  <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                >
                  ...
                  {{ isCreatingCode ? 'Creating...' : 'Create Booking Code' }}
                </button>
              </div>
