<template>
      ...
      <div class="w-full  bg-transparent  overflow-hidden ">
        ...
        <div class="border-t border-gray-200 bg-gray-50 p-2">
          ...
          <button 
            ...
            class="w-full py-1 cursor-pointer bg-[#0AF0B5] text-white font-bold rounded-lg shadow-lg hover:from-emerald-700 hover:to-emerald-600 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
          >
  ...
  const placeBet = () => {
    ...
    // Optional: Clear betslip after placing bet
    // sportsBets.value = []
  }
  </script>
