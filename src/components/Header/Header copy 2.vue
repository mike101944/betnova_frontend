              ...
              <div data-v-3bcad4de="">
                ...
                <a data-v-3bcad4de="" href="/"
                  ...
                  data-test-id="nav-homepage-link" aria-current="page">
                                    <svg data-v-02f45589=""  block md:hidden data-v-3bcad4de="" class="svg-icon logo-short"
                                        icon-fallback="logo" style="vertical-align: middle;"><!---->
                                        <use data-v-02f45589="" xlink:href="#logo-short"></use>
                                    </svg>
                 
                  <svg data-v-02f45589="" data-v-3bcad4de="" 
                    class="svg-icon logo" 
                    style="vertical-align: top;">
                    <use xlink:href="#logoh"></use>
                </svg>
                </a>
              </div>
            </div>
            ...
            <div data-v-3bcad4de="" class="header-balance-section">
              ...
              <span  data-v-2658eb31="" data-v-3bcad4de="">
                <a data-v-2658eb31="" href="/deposit"
                  ...
                  <span data-v-2658eb31="" class="button balance">TSh 1,005.46</span>
...
.tabs.dark .tabs-menu .tabs-selector.active[data-v-d3915418] {
  color: #0AF0B5;
  background: 0 0;
  border-bottom: 2px solid #0AF0B5;
}
