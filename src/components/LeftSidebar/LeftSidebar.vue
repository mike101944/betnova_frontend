      ...
      <div class="flex-1 overflow-y-auto py-4">
        <div class="space-y-1 px-3">
          ...
          <button 
            ...
            :class="activeItem === 'home' ? 'bg-[#0AF0B5] text-[#1a1e24]' : 'text-gray-400 hover:bg-[#252a2d] hover:text-white'"
          >
          ...
          <button 
            ...
            class="w-full flex items-center gap-3 p-3 rounded-lg transition-all duration-200"
            :class="activeItem === 'sports' ? 'bg-[#0AF0B5] text-[#1a1e24]' : 'text-gray-400 hover:bg-[#252a2d] hover:text-white'"
          >
          ...
          <button 
            ...
            class="w-full flex items-center gap-3 p-3 rounded-lg transition-all duration-200"
            :class="activeItem === 'casino' ? 'bg-[#0AF0B5] text-[#1a1e24]' : 'text-gray-400 hover:bg-[#252a2d] hover:text-white'"
          >
          ...
          <button 
            ...
            class="w-full flex items-center gap-3 p-3 rounded-lg transition-all duration-200"
            :class="activeItem === 'live' ? 'bg-[#0AF0B5] text-[#1a1e24]' : 'text-gray-400 hover:bg-[#252a2d] hover:text-white'"
          >
          ...
          <button 
            ...
            class="w-full flex items-center gap-3 p-3 rounded-lg transition-all duration-200"
            :class="activeItem === 'settings' ? 'bg-[#0AF0B5] text-[#1a1e24]' : 'text-gray-400 hover:bg-[#252a2d] hover:text-white'"
          >
          ...
          <button 
            ...
            class="w-full flex items-center gap-3 p-3 rounded-lg transition-all duration-200"
            :class="activeItem === 'support' ? 'bg-[#0AF0B5] text-[#1a1e24]' : 'text-gray-400 hover:bg-[#252a2d] hover:text-white'"
          >
