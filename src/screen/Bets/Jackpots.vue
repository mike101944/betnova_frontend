    ...
    <div v-else>
      ...
      <section class="flex flex-col items-center justify-center min-h-[60vh]">
        <div class="bg-white rounded-2xl shadow-xl p-12 text-center max-w-md">
          ...
          <h3 class="text-2xl font-bold text-gray-900 mb-2">No Jackpot Bets</h3>
          <p class="text-gray-500 mb-8">You don't have any active Jackpot bets at the moment. Start betting now!</p>
          <a 
            href="/" 
