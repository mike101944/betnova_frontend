...
// Define computed property correctly at the top level
            ...
            <section data-v-beccd7ea="" aria-hidden="false" class="tab-section"  v-if="hasData">
                <div data-v-34417751="" data-v-beccd7ea="">
                            ...
                            <div data-v-34417751="" class="bet-line bet-status">
                                <div class="outcome">0/2 </div>
                                <div data-v-beccd7ea="" class="cashout-container"><span data-v-beccd7ea=""
                                    class="cashout-title">Cashout</span> <span data-v-beccd7ea="" class="cashout-icon"><svg
                                    data-v-02f45589="" data-v-beccd7ea="" class="svg-icon icon-size-small"
