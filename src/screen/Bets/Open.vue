    ...
    <div v-else>
            ...
            <div class="flex flex-row items-center justify-between">
              ...
              <div class="flex flex-col">
                ...
                <div class="rounded-xs ">
                  <span class="text-xs  font-medium text-gray-600">{{formatBalance(bet.stake)  }}</span>
                </div>
              </div>
              ...
              <div class="flex flex-col">
                ...
                <div class="rounded-xs ">
                  <span class="text-xs   font-medium text-gray-600">{{ formatBalance(bet.potentialReturn)  }}</span>
                </div>
              </div>
      ...
      <section v-else class="flex flex-col items-center justify-center">
        <div class="bg-transparent rounded-2xl shadow-xl px-3 py-2 text-center max-w-md">
          ...
          <h3 class="text-sm font-bold text-gray-400 mb-2">No Open Bets</h3>
