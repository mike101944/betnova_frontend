    ...
    <div v-else>
      ...
      <section v-if="hasData" class="space-y-4 ">
        ...
        <div
          ...
          class="group bg-sky-950/60 rounded-bl-[50px] rounded-tr-[50px] hover:shadow-xl transition-all duration-300 border-y border-gray-500 overflow-hidden"
        >
          <!-- Header with Gradient -->
          <div class="bg-sky-950/20 px-2  py-2 pr-4 border-b border-gray-600">
          ...
          <!-- Main Content -->
          <div class="px-2 py-2 bg-white pl-4">
            <!-- Stats Grid -->
