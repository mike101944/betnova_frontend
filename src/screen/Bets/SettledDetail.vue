<template>
    <div class="h-full bg-sky-800">
        <!-- Header with proper typography -->
        <div class="sticky top-0 bg-sky-800  z-10">
            <div class="max-w-3xl mx-auto px-4">
                <!-- Back Button -->
                <button @click="router.back()" 
                        class="inline-flex items-center py-3 text-sm font-medium text-gray-300 hover:text-emerald-600 transition-colors">
        ...
        <div v-else-if="bet" class="w-full mx-auto px-4 py-2">
            ...
            <div class="bg-white rounded-b-xl shadow-sm border-b border-gray-200 p-1 py-2 gap-2  px-3 mb-1">
                ...
                <div class="flex items-center justify-between mt-1">
                        ...
                        <span class="text-xs font-black text-gray-500 ">{{ Number(bet.totalOdds).toFixed(2) }}</span>
                    </div>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center justify-between mb-1">
                        ...
                        <span class="text-[10px] font-black text-gray-500 ">- {{ formatCurrency(calculateTax(bet)) }}</span>
                    </div>

                <!-- Net Payout -->
                <div class=" border-t border-gray-200 py-2">
                    <div class="flex items-center justify-between">
                        <span class="text-xs  text-gray-500 font-inter">Net Payout</span>
                        <span class="text-[10px] font-black text-green-600 ">{{ formatCurrency(calculateFinalPayout(bet)) }}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-transparent rounded-xl  px-5 mt-2 flex items-center justify-center gap-2">
                <span class="text-xs font-medium text-gray-300 font-inter">Bet Placed</span>
                <span class="text-[10px] text-gray-300 font-inter mt-1">{{ formatDate(bet.createdAt) }}</span>
            </div>
