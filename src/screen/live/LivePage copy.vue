...
<template>
            ...
            <div class="bg-sky-900/50 backdrop-blur-md rounded-2xl border border-sky-700/50 overflow-hidden shadow-2xl">
              ...
              <div class="px-2 py-2  custom-scroll">
                <div class="flex gap-1 flex-col  w-full">
                  ...
                  <!-- Single card loop - nimeondoa duplicate -->
                  <div
                    v-for="game in liveMatchesData"
                    :key="game.id"
                  ...
                  <!-- Empty State -->
                  <div v-if="liveMatchesData.length === 0" class="w-full p-8 text-center">
  ...
  onMounted(() => {
    ...
    if (liveMatchesData.value.length > 0) {
      selectedMatch.value = liveMatchesData.value[0]
