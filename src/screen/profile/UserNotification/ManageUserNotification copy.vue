        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div class="flex items-center gap-4">
            <div class="w-16 h-16 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center">
              <span class="text-2xl font-bold text-white">{{ selectedUser.phone_number?.slice(-4) }}</span>
            </div>
            <div>
              <h3 class="text-xl font-bold text-gray-800">{{ selectedUser.phone_number }}</h3>
      ...
      <div v-if="selectedUser" class="bg-white border border-gray-200 rounded-xl p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div class="border border-gray-200 rounded-lg p-4">
            <label class="block text-sm font-medium text-gray-700 mb-2">Add Balance</label>
            <div class="flex gap-2">
              <input 
              ...
              <button 
                @click="addBalance"
                :disabled="loading"
                class="px-4 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 transition-all disabled:opacity-50"
              >
                Add
              </button>
            </div>
          ...
          <!-- Deduct Balance -->
          <div class="border border-gray-200 rounded-lg p-4">
            <label class="block text-sm font-medium text-gray-700 mb-2">Deduct Balance</label>
            <div class="flex gap-2">
              <input 
                v-model.number="deductAmount"
                type="number"
                placeholder="Amount"
                class="flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500"
              />
              <button 
                @click="deductBalance"
                :disabled="loading"
                class="px-4 py-2 bg-red-500 text-white rounded-lg hover:bg-red-600 transition-all disabled:opacity-50"
              >
                Deduct
              </button>
            </div>
